...
def scrabble(word):
    '''
    Функция, которая считает кол-во очков (points), полученное за слово (word) для игры Эрудит
    :param word: входное слово
    :return: количество очков, полученное за слово согласно правилам
    '''
    point_dict = {
        1: "авеёинорст",
        2: "дклмпу",
    ...
    points = sum([key for letter in word for key, value in point_dict.items() if letter in value])
    return points
